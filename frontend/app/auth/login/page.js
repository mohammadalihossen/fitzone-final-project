        ...
        >
          ...
          <div className="flex justify-center mb-8">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center text-black font-black text-lg">
                💪
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              >
                <FiMail
                  className={`shrink-0 transition-colors ${focused === "email" ? "text-primary" : "text-muted"}`}
                  size={18}
                />
                <input
                  type="email"
            ...
            <div>
              ...
              >
                <FiLock
                  className={`shrink-0 transition-colors ${focused === "password" ? "text-primary" : "text-muted"}`}
                  size={18}
                />
                <input
...
// ✅ Suspense দিয়ে wrap করা — Vercel deploy এর জন্য জরুরি
