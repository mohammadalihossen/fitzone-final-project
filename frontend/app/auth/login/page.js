...
function LoginContent() {
  ...
  return (
    <div className="p-8 md:p-10"
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <button type="button" className="text-primary text-xs hover:underline transition-colors">
              Forgot Password?
            </button>
          </div>
      ...
      <p className="text-center text-muted/70 text-xs mt-7 font-light">
        Don't have an account?{" "}
        <Link
          href="/auth/register"
          className="text-primary/90 font-medium hover:underline ml-1"
        >
          Create one free →
        </Link>
      </p>
